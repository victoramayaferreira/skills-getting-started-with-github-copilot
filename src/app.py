...
def signup_for_activity(activity_name: str, email: Annotated[EmailStr, Query(max_length=100)]):
...
def unregister_from_activity(activity_name: str, email: Annotated[EmailStr, Query(max_length=100)]):
